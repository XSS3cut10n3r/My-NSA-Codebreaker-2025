...
![Mount screenshot](images/statistics.png){ align=center }

The FTP traffic stood out so I took a closer look.

![Mount screenshot](images/ftpdata.png){ align=center }
...
![Mount screenshot](images/tcpstream.png){ align=center }
...
![Mount screenshot](images/network.png){ align=center }
...
![Mount screenshot](images/stor.png){ align=center }
...
![Mount screenshot](images/srcmac.png){ align=center }
![Mount screenshot](images/arpsrc.png){ align=center }
...
![Mount screenshot](images/router3loopback.png){ align=center }
